...
class TestAdditiveUtilitarian(unittest.TestCase):

    def test_one(self):
        additive = AdditiveUtilitarian(test_data.movie_set_1, test_data.data_set_1)
    ...
    def test_two(self):
        additive = AdditiveUtilitarian(test_data.movie_set_2, test_data.data_set_2)
        movie = additive.get_recommendation()
        max_score = additive.get_max_rating()
    ...
    def test_three(self):
        additive = AdditiveUtilitarian(test_data.movie_set_3, test_data.data_set_3)
        movie = additive.get_recommendation()
        max_score = additive.get_max_rating()
    ...
    def test_four(self):
        additive = AdditiveUtilitarian(test_data.movie_set_4, test_data.data_set_4)
        movie = additive.get_recommendation()
        max_score = additive.get_max_rating()
    ...
    def test_five(self):
        additive = AdditiveUtilitarian(test_data.movie_set_5_6, test_data.data_set_5)
        movie = additive.get_recommendation()
        max_score = additive.get_max_rating()
    ...
    def test_six(self):
        additive = AdditiveUtilitarian(test_data.movie_set_5_6, test_data.data_set_6)
        movie = additive.get_recommendation()
        max_score = additive.get_max_rating()
